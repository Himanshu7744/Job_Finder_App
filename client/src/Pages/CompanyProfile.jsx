                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <textarea
                        ...
                        focus:ring-1 focus:ring-blue-500 text-base px-4 py-2 resize-none"
                        rows={4}
                        cols={6}
                        {...register("about", {
                    ...
                    <div className="mt-4">
                      ...
                      <CustomButton
                        type="submit"
                        containerStyles="inline-flex justify-center rounded-md border 
          ...
          {user?.accountType === undefined && info?._id === user?._id && (
            <div className="flex items-center justifu-center py-5 md:py-0 gap-4">
              <CustomButton
                ...
                iconRight={<FiEdit3 />}
                containerStyles={`py-1.5 px-3 md:px-5 focus:outline-none bg-blue-800  hover:bg-blue-800 text-white rounded text-sm md:text-base border border-blue-800`}
              />
