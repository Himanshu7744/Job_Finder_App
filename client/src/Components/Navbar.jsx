    ...
    <div>
      <Menu as="div" className="inline-block text-left">
        <div className="flex">
          ...
          w-full rounded-md bg-white md:px-4 py-2 text-sm 
          font-medium text-slate-700 hover:bg-opacity-20"
          >
            <div
              className="leading[20px] flex flex-col
            items-start"
            >
        ...
        >
          ...
          origin-top-right divide-y dividfe-gray-100 
  ...
  return (
    <>
      <div className="relative bg-[#f7fdfd z-50">
        <nav className="Container mx-auto flex item-center justify-between p-5">
          <div>
            <Link to="/" className="text-blue-600 font-bold text-5xl">
          ...
          <div className="hidden lg:block ">
            {!user?.token ? (
              <Link to="/user-auth">
                <CustomButton
                  title="Sign In"
                  containerStyle="text-blue-600 py-1.5 px-5
